...
function(t, e) {
    ...
    initMobileNav(), initNavHide(), caseTeaseNext(), imageRatio(), sectionJump(), videoPlay(), introAnimate(), console.log("Looking for this? https://github.com/GlitchWitch/glitchwitch.io")
